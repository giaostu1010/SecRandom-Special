...
[PageInfo("settings.listManagement.lottery.genderSettings", "\uE7C3", "settings.listManagement", PageLocation.Top, true)]
public partial class GenderSettingsPage : UserControl
{
    ...
    private async void SaveButton_OnClick(object? sender, RoutedEventArgs e)
    {
        try
        {
            ...
            {
                _saved = true;
                await ShowMessageAsync("成功", $"成功保存 {_prizes.Count} 个奖品的类型信息");
            }
            else
            {
